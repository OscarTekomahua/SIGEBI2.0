...
<style>
    ...
    /* BASIC */
    html {
        background: #35A579 url('assets/img/utez.jpg') no-repeat center center fixed;
...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <form method="post" action="RegistrarUsuarioServlet" id="frm">
            ...
            <input type="form" id="apellido1" class="fadeIn second" name="apellido1" placeholder="Apellido Paterno" required>
            <label for="apellido2"><b>Apellido Materno:</b></label>
            <input type="form" id="apellido2" class="fadeIn second" name="apellido2" placeholder="Apellido Materno" required>
            <label for="correo"><b>Correo:</b></label>
            <input type="email" id="correo" class="fadeIn second" name="correo" placeholder="Correo Institucional" required>
            <label for="contra"><b>Contraseña: </b></label>
            <input type="password" name="contra" id="contra" value="" placeholder="Ingrese su contraseña" required>
        ...
        <!-- Remind Password -->
        <div id="formFooter">
            <a class="underlineHover" href="index.jsp">Ya tengo un usuario</a>
        </div>
