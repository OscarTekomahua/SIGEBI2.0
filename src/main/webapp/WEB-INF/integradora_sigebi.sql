create database integradora_sigebi;
use integradora_sigebi;
...
insert into persona (nombres, apellido1, apellido2) 
values ('Gonzalo', 'Bahena', 'Perez');
insert into persona (nombres, apellido1, apellido2) 
values ('Joaquin', 'Guzman', 'Loera');
insert into persona (nombres, apellido1, apellido2) 
...
values (1, 1, '20223tn077@utez.edu.mx', sha2('admin', 256), sha2('admin123', 256));
insert into usuario (id_persona, rol, correo_institucional, contraseña, codigo)
values (2, 2, '20223tn053@utez.edu.mx', sha2('bibliotecario', 256), sha2('biblio321', 256));
insert into usuario (id_persona, rol, correo_institucional, contraseña, codigo)
values (3, 1, '20223tn042@utez.edu.mx', sha2('osc4r1t0', 256), sha2('0sc4r13', 256));
insert into usuario (id_persona, rol, correo_institucional, contraseña, codigo)
values (4, 3, '20223tn058@utez.edu.mx', sha2('j04qu1n', 256), sha2('ch4p1t0', 256));
select * from usuario;
