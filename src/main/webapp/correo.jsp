...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <!-- Login Form -->
        <form method="post" action="RestablecerContraUsuarioServlet">
            <p>Ingresa tu correo</p>
            <input type="email" id="correo" class="fadeIn second" name="correo" placeholder="Correo Institucional">
            <input type="submit" class="fadeIn fourth" value="Enviar Codigo">
        </form>
