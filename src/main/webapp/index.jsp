  ...
  <div id="formContent">
    ...
    <c:if test="${empty sesion}">
      <form method="post" action="login">
        ...
        <input type="email" id="email" class="fadeIn second" name="correo" placeholder="Correo Institucional" required="">
        <label for="contra" class="sr-only">Contraseña: </label>
        <input type="password" id="contra" class="fadeIn third" name="contra" placeholder="Contraseña" required="">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="correo.jsp">Reestablecer contraseña</a>
    </div>
    <div id="formFooter">
